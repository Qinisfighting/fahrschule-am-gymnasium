        ...
        <div className="info--imgs">
          ...
          >
            <fieldset>
              ...
              <img src={tüv} alt="tüv" style={{width: 350}}/>
            </fieldset>
          </a>
          <a
          ...
          <a href="https://www.asb-sh.de/standort/asb-regionalverband-ostholstein" target="_blank">
            <fieldset>
              ...
              <img src={asb} alt="ASB" style={{width: 300}}/>
            </fieldset>
          </a>
