              ...
              <div className="kontakt-text-content--box"> 
                    <div className="k--filialen">
                              <div className="filiale">
                                  <a href="https://www.google.com/maps/dir//54.2900595,10.8933194/@54.2899994,10.8109576,12z?entry=ttu" target="_blank"><img src={location2} alt="navi" className="navi"/></a>  
                              ...
                              <div className="filiale">
                                  <a href="https://www.google.com/maps/dir//Eutiner+Str.+11,+23738+Lensahn/@54.2198363,10.8023197,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x47b27f24f7c78c67:0xc481290815469c3e!2m2!1d10.8847198!2d54.2198644?entry=ttu" target="_blank"><img src={location2} alt="navi" className="navi"/></a> 
                                  <div>
