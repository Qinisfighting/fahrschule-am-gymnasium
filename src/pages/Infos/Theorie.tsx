        ...
        <div className="textContainer">
          ...
          <div className="theorieunterricht--thema">
            <div className="theorieunterricht--thema-left">
              ...
              <p>Thema 7: Teilnehmer am Straßenverkehr – Besonderheiten und Verhalten</p>     
            </div>
            <div className="theorieunterricht--thema-right">
              <p>Thema 8: Geschwindigkeit, Abstand und Umweltschonende Fahrweise</p>
              <p>Thema 9: Verkehrsbeobachtung und Verkehrsverhalten bei Fahrmanövern</p>
              <p>Thema 10: Ruhender Verkehr</p>
              <p>Thema 11: Verhalten in besonderen Situationen, Folgen von Verstößen gegen Verkehrsvorschriften</p>
              <p>Thema 12: Lebenslanges Lernen</p>
              <p>Thema 13 (B1): Technische Bedingungen, Personen- und Güterbeförderung Umweltschutz</p>
          ...
          <div className="t-kalendar"> 
            <h2>Kalender</h2> 
            <p style={{paddingTop:5, paddingBottom:20, color:"red"}}>Grundunterrichte und Klasse B für 2024. Spezielle Unterrichte nach Absprache.</p> 
