export default function Theorie() {
    return (
        <div className="textContainer">
            ...
            <h3>Thema 4: Straßenverkehrssystem und Bahnübergänge</h3>
            <h3>Thema 5: Grundregel, Vorfahrt und Verkehrszeichen</h3>
            <h3>Thema 6. Verkehrszeichen und Verkehrseinrichtungen</h3>
            <h3>Thema 7: Teilnehmer am Straßenverkehr – Besonderheiten und Verhalten</h3>
            <h3>Thema 8: Geschwindigkeit, Abstand und Umweltschonende Fahrweise</h3>
            <h3>Thema 9: Verkehrsbeobachtung und Verkehrsverhalten bei Fahrmanövern</h3>
